...
curl -s "$image_link" -o "$HOME/Pictures/backgrounds/wallpaper.jpg"
(cd ~/pix/wallpapers && curl -O "$image_link")

swww img "$HOME/Pictures/backgrounds/wallpaper.jpg" --transition-type random --transition-step 5 --transition-fps 165
